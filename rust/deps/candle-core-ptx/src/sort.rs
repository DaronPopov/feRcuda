...
mod cuda {
    use super::*;
    use crate::cuda_backend::cudarc::driver::{CudaSlice, DeviceRepr, LaunchConfig, ValidAsZeroBits};
    ...
    impl crate::cuda_backend::Map1Any for ArgSort {
        fn f<T: DeviceRepr + WithDType + ValidAsZeroBits, W: Fn(CudaSlice<T>) -> S>(
            ...
            let ncols_pad_i32 = ncols_pad as i32;
            let params = (&slice, &dst, &ncols_i32, &ncols_pad_i32);
